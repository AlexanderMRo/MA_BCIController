...
class LiveAdvance():
    ...
    def on_new_com_data(self, *args, **kwargs):
        ...
        # note: there might be a better option to do it, though I can't quite understand how,
        # maybe ask support after all? (If you can't figure out how to do stuff on your own)

        # we also need to figure out how to do training entirely in python (or maybe actually just
        # do it in the app, might be a lot easier)

        # for the testing we might need to formulate some advice of which mental commands one could use c:
        # (but that's stuff for much later)

        # (low prio)
        # might also try to copy the stream of data seen in the official docs on bci to see how we
